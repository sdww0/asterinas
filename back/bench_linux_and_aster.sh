...
run_benchmark() {
    ...
    if [ ! -f "${MODULES_DIR}" ]; then
        ...
        # Changed below =============================================================================
        mkdir -p "${MODULES_DIR}/drivers/net"
        mkdir -p "${MODULES_DIR}/net/core"
        sudo cp /lib/modules/${KERNEL_VERSION}/kernel/drivers/net/virtio_net.ko "${MODULES_DIR}/drivers/net/virtio_net.ko"
        sudo cp /lib/modules/${KERNEL_VERSION}/kernel/drivers/net/net_failover.ko "${MODULES_DIR}/drivers/net/net_failover.ko"
        sudo cp /lib/modules/${KERNEL_VERSION}/kernel/net/core/failover.ko "${MODULES_DIR}/net/core/failover.ko"
        # Changed above =============================================================================
    fi
